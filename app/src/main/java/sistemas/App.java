...
public class App {
    ...
    public static int convertirCelsiusAFahrenheit(double celsius) {
        try {
            int fahrenheit = 32 + (9 * (int)celsius / 5);
            return (fahrenheit);
        } catch (Exception e) {
            return 0;
        }
    ...
    public static int convertirATotalSegundos(int dias, int horas, int minutos, int segundos) {
        try {
            int totalSegundos = (dias * 24 * 60 * 60) + (horas * 60 * 60) + ((int)minutos * 60) + (int)segundos;
    ...
    public static int calcularSaldoTaquilla(double base, double ingresos, double retiros) {
        try {
           int saldo = (int)base + (int)ingresos - (int)retiros;
            return (saldo );
        } catch (Exception e) {
            return 0;
        }
